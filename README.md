...
packages/cli     @tech-inject/techinject-cli — npx installer
```
...
pnpm --filter @tech-inject/techinject-cli build
```
...
TECH_INJECT_TOKEN=<session-token> npx @tech-inject/techinject-cli add table -r https://api.your-domain.com
# or free (no token)
npx @tech-inject/techinject-cli add button -r https://api.your-domain.com
```
